...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        iGetView view = new ViewGenericClass();

        ModelClassHash hClass = new ModelClassHash();
        hClass.addStudentsList(studList);
        hClass.getStudentsFromFile("StudentDB.csv");

        ControllerClass controller = new ControllerClass(hClass, view);
